    ...
    <div className="w-72 h-full bg-white border-r border-slate-100 flex flex-col shadow-[20px_0_40px_-20px_rgba(0,0,0,0.05)] overflow-hidden">
      ...
      <div className="flex-shrink-0 pt-10 pb-8 px-8">
        ...
        <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full border transition-all duration-500 ${
          isLocked ? 'bg-red-50 border-red-100 text-red-600' : 
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 px-5 py-4 rounded-2xl font-bold transition-all duration-300 group relative ${
                isActive 
      ...
      <div className="flex-shrink-0 p-6 mt-auto">
        <div className={`p-5 rounded-[2rem] border transition-all duration-300 ${
          isLocked ? 'bg-red-50 border-red-100' : 'bg-slate-50 border-slate-100 shadow-inner'
        }`}>
