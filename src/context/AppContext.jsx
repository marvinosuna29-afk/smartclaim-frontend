// Version 1.1.0 - Loop Fix Deployment
...
export const AppProvider = ({ children }) => {
  ...
  const actions = {
    ...
    addOrder: async (orderData) => {
      ...
      if (r.ok) {
        // CRITICAL: Use the ID generated by the Database (e.g., r.data.id)
        // Do NOT use a local counter or a hardcoded value.
        const serverOrder = r.data.order || r.data;

        setOrders(prev => {
          // Prevent duplicates in state if the socket already added it
